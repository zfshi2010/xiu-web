...
var pageaction = function(){
    $.get('/api/serviceForTypeMessage/index?t='+new Date().getTime(),{size:10,serviceForTypeId:$("#serviceForTypeId").val()},function(data){
...
var pageselectCallback = function(page_index, jq, size){
    ...
    if(currentPageData!=null){
        ...
        $.get('/api/serviceForTypeMessage/index?t='+new Date().getTime(),{size:size,page:page_index, serviceForTypeId:$("#serviceForTypeId").val()
        },function(data){
...
function fillData(data){
    ...
    $.each(data,function(k,v){
        ...
        html += `<tr>
            ...
            <td>${v.createTime}</td>
            <td>
				<a class="btn btn-info btn-sm" href="/admin/serviceForTypeMessage/update.html?id=${v.id}">修改</a>
...
function del(id){
    ...
    $.ajax({
        url: "/api/serviceForTypeMessage/delete?id=" + id,
        type: 'DELETE',
