...
var pageaction = function(){
    $.get('/api/banner/index?t='+new Date().getTime(),{size:10,title:$("#title").val()},function(data){
...
var pageselectCallback = function(page_index, jq, size){
    ...
    if(currentPageData!=null){
        ...
        $.get('/api/banner/index?t='+new Date().getTime(),{size:size,page:page_index, title:$("#title").val()
        },function(data){
...
function fillData(data){
    ...
    $.each(data,function(k,v){
        ...
        html += `<tr>
            ...
            <td>${v.createTime}</td>
            <td>
				<a class="btn btn-info btn-sm" href="/admin/banner/update.html?id=${v.id}">修改</a>
